      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 leading-relaxed mt-4">
            ...
            what the people who matter most are saying about your brand.Whether
            you need reviews for your services, products, or business locations
            — Customers Reports reviews help you drive more traffic from paid
            and organic search results, and make the purchasing decision easy
            once those shoppers get to your site.
          </p>
